...
--
-- Host: localhost:3306
-- Generation Time: Oct 24, 2019 at 03:44 AM
...
CREATE TABLE `album` (
  ...
  `track_id` varchar(256) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `album` (`id`, `title`, `artist_id`, `year`, `ext_data`, `track_id`) VALUES
(1, 'Good Humor', 8, 1998, 'The words Saint Etienne themselves give me a similar feeling, one of a world in which all the women wear pearls and are able to sing in key, and one where the men drive sports cars and never stumble—a world where nostalgia is beside the point because all of us live inside a bright and glorious present. Douglas Coupland', 'Wood Cabin'),
(2, 'American IV: The Man Comes Around', 3, 2002, '', 'Hurt'),
(3, 'Version 2.0', 7, 1998, '', 'Special'),
(4, 'The Best of the Song Books', 6, 1993, '', 'S\'Wonderful'),
(5, 'Simple Things', 9, 2001, '', 'In the Waiting Line'),
(6, 'Fashion Nugget', 10, 1996, 'special guest: Greg Vincent, pedal steel guitar on \"She\'ll Come Back to Me\"', ''),
(7, 'nine objects of desire', 11, 1996, '', ''),
(8, 'Woodface', 12, 1991, '', ''),
(9, 'Blossom Dearie: Verve Jazz Masters 51 ', 13, 1996, '', ''),
(10, 'Astrud Gilberto: Verve Jazz Masters 9', 14, 1994, '', ''),
(11, 'Post', 1, 1995, '', ''),
(12, 'Garbage', 7, 1995, '', '');
