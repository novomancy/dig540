...
--
-- Host: localhost:3306
-- Generation Time: Oct 19, 2017 at 12:52 AM
...
INSERT INTO `track` (`id`, `title`, `artist_id`, `location_id`, `record_year`, `length`, `notes`) VALUES
(1, 'From the Mountains to the Sea', 1, 1, 1989, '00:03:56', 'Recorded in the Fall of 1989 in Room 302 (\"The 3rd Oz\"). Recorded on a Fostex 4-track with Paul performing all instruments: Keyboards, guitar, bongos and triangle.'),
(2, 'Bread and Water', 1, 2, 1992, '00:05:25', 'Recorded late summer at Spring St, Diane Smitherman joins Paul on vocals in a sleepy bossa. Paul plays electric guitar and bass. Drums from a Roland drum machine. ');
