...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2020 at 02:20 PM
...
CREATE TABLE `genre` (
  `id` int(11) NOT NULL COMMENT 'Why won''t this populate?',
...
--
ALTER TABLE `genre`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Why won''t this populate?', AUTO_INCREMENT=11;
...
--
ALTER TABLE `genre`
  ADD CONSTRAINT `genre_ibfk_1` FOREIGN KEY (`id`) REFERENCES `track` (`id`);
