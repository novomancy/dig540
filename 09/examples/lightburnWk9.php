...
<?php
    ...
    //shelley's assignment for week 9
    ...
    class Album{
        ...
        public function getGenres(){ 
            for($j=0; $j<count($this->genres); $j++){
                if($j%2==0) print_r("<span style='color:green'>Genre #".($j+1)." is ".$this->genres[$j]."</span><br>");
                else print_r("<span style='color:grey'>Genre #".($j+1)." is ".$this->genres[$j]."</span><br>");
            }
        }
        ...
        public function getSubgenres(){ 
            for($j=0; $j<count($this->subgenres); $j++){
                if($j%2==0) print_r("<span style='color:violet'>Subgenre #".($j+1)." is ".$this->subgenres[$j]."</span><br>");
                else print_r("<span style='color:orange'>Subgenre #".($j+1)." is ".$this->subgenres[$j]."</span><br>");
            }
        }
