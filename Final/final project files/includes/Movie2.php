...
class Movie{
	...
	//this code achieves genre and subgenre both highlighted but clicking either yields error messages which I ultimately couldn't debug
	//the uploaded photo (Movie2php.png) shows what was visible on the site after uploading this php file
	//"error message: Fatal error: Uncaught Error: Call to undefined method Movie::load() in /home/shcrawfo/public_html/list_movies.php:8 Stack trace: 
	//#0 {main} thrown in /home/shcrawfo/public_html/list_movies.php on line 8" 
	//continued on trying to link up subgenre (see Movie3.php for one of many attempts) as I was able to with genre but just never got there. 
	//the most frequent error message I received related to Movie::load() which I knew was coming from the list_movies.php file, but I could never reach 
	//the right synergy for the movie.php and list_movies.php files regarding separating genre and subgenre in load functions. 
