<?php
    ...
    class Album{
        ...
        public function setData(){
            $this->title = str_getcsv($title);
            $this->rank = str_getcsv($rank);
            $this->year = str_getcsv($year);
            $this->artist = str_getcsv($artist);                  
            $this->genres = str_getcsv($genre);
            $this->subgenres = str_getcsv($subgenre);
        }

        public function getData(){
            
            $this->$albums[$i]->getTitle();
            $this->$albums[$i]->getYear();
            $this->$albums[$i]->getRank();
            $this->$albums[$i]->getArtist();
            $this->$albums[$i]->getGenres();
            $this->$albums[$i]->getSubgenres();
        }
