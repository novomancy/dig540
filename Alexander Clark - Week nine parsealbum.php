    ...
    class Album{
        ...
        public function getSubgenres(){
            for($j=0; $j<count($this->subgenres); $j++){
                if($j%2==0) print_r("<span style='color:green'>Subgenre #".($j+1)." is ".$this->subgenres[$j]."</span><br>");
                else print_r("<span style='color:pink'>Subgenre #".($j+1)." is ".$this->subgenres[$j]."</span><br>");
            }
        }
