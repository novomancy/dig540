...
<html lang="en">
  ...
  <body>
    <h1>Welcome to Super Album List!!</h1><br>
    ...
    for($i=0; $i<count($first_line); $i++){
        print_r('<div class="w3-container w3-khaki">'.'Column header found: '.$first_line[$i].'</div>');
    }
    print_r('<br>');
            ...
            if($i < 4){
                ...
                for($j=0; $j<count($genres); $j++){
                    ...
                    if($i%2==0){
                        ...
                        if($j%2!=0){
                        print_r("<span style='color: darkorange;'>$first_line[$i] #".($j+1)." is $genres[$j]</span><br>");}
                        else{
                        print_r("<span style='color: darkmagenta;'>$first_line[$i] #".($j+1)." is $genres[$j]</span><br>");}
