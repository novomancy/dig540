...
elseif(isset($_POST['update'])){
  $Book = new Book($_POST['bookid'], $_POST['book_title'], $_POST['book_num'], $_POST['story_serial'], $_POST['story_serial_number']);
  $Book->update();
}
?>
...
<style>
  ...
  <div class="divI">
    ...
    <br>
    <u><h3>Update information on a book in the database</h3></u><br>
    <form method="POST" action="">
      <lable> -REQUIRED- Enter the book id number:</lable>
      <input type="text" name="bookid" class="ifield"></input><br>
      <lable> -OPTIONAL- Update the book's title:</lable>
      <input type="text" name="book_title" class="ifield"></input><br>
      <lable> -OPTIONAL- Update the book number in the Discworld series:</lable>
      <input type="text" name="book_num" class="ifield"></input><br>
      <lable> -OPTIONAL- Update the book's category:</lable>
      <input type="text" name="story_serial" class="ifield"></input><br>
      <lable> -OPTIONAL- Update the number in the book's order of publication in it's category:</lable>
      <input type="text" name="story_serial_number" class="ifield"></input><br><br>
    ...
    <div class="divO">
      ...
      <?php } elseif(isset($_POST['update'])){ ?>
        <?php if(isset($Book)) { ?>
          <p>The information for Book ID: "<?php echo $Book->bookid; ?>" has been updated in the database.</p>
          <?php } else { ?>
            <p>No records have been updated. Please enter a valid Book ID and try again. Thanks!</p>
        <?php } ?>
      <?php } ?>
    </div>
  </body>
